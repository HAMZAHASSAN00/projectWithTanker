        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            UserModel userModel = UserModel(
              ...
              tempPercentageAutoMode: userData['tempPercentageAutoMode'],
              waterTimeArrival: userData['waterTimeArrival'],
              groundAutoMode: userData['groundAutoMode'],
              roofAutoMode: userData['roofAutoMode'],
                ...
                children: [
                  ...
                  Card(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Text(
                        userModel?.waterTimeArrival ?? '',
                      ),
                      onTap: () {
                        _showEditDialog(
                          'Edit Water Time Arrival',
                          _waterTimeArrivalController,
                          userModel?.waterTimeArrival ?? '',
                              (value) {
                            setState(() {
                              userModel.waterTimeArrival = value;
                              userRepository.updateFirestoreData('waterTimeArrival', value, 'Users', userModel.email.toString());
                            });
                          },
                        );
                      },
                      ...
                      onTap: () {
                        _showEditDialog(
                          ...
                          userModel?.groundAutoMode.toString() ?? '',
                              (value) {
                            setState(() {
                              userModel.groundAutoMode = double.parse(value);
